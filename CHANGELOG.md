...
- nvim: parser installs are skipped below nvim 0.12 or without a `tree-sitter` CLI >= 0.26.1 and a C compiler, instead of re-downloading and failing on every start; telescope is gated to nvim >= 0.11, which it requires.
